...
### 🔹 Development  
React.js, Next.js, Node.js, Django, Django REST Framework

### 🔹 AI & ML  
NumPy, Pandas, Matplotlib, Scikit-Learn, PyTorch, TensorFlow, NLP

### 🔹 Software  
Fusion 360, EasyEDA, ETABS
...
- Built **5+ high-impact websites** with 4K+ total registrations  
- Debugged & improved 2+ major production websites  
- Designed **2500+ personalized yearbooks** (render-to-PDF pipeline)  
- Assisted execution of Alumination Fest (10K+ footfall)
...
<!--
**TarunKadam/TarunKadam** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
